...
#chat:hover {background: #f8e9e2; color: navy; cursor: pointer;}
...
<div id="wrapper">
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-lg-8 hidden-md-down">
               <div class="topmenu text-right" style="font-size: 15px;">
                  <ul class="list-inline">
                     ...
                     <c:otherwise>
                        ...
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/mypage/qna.do">FAQ</a></li>
                     	<button class="btn btn-outline-primary my-2 my-sm-0" id="chat" type="button" onclick="fn_chatting();">CHAT</button>
                     </c:otherwise>
                     </c:choose>
                  </ul>
                  <!-- end ul -->
   ...
   <div class="header-section" style="padding-top: 10px; padding-bottom: 0px;">
      <div class="container">
         <div class="header">
         <div class="row">
            <div class="col-md-3" style="text-align: center; padding-right: 0px; padding-left: 55px;">
            ...
            <div class="collapse navbar-collapse" id="cloapediamenu">
               <ul class="navbar-nav col-12" style="padding-left: 15px;">
                        <li class="nav-item dropdown has-submenu" id="nav_li01" style="margin-right: 17px;"><a
                        ...
                        <li class="nav-item dropdown has-submenu col-2" id="nav_li04" style="margin-left: -11px; margin-right: 10px;"><a
