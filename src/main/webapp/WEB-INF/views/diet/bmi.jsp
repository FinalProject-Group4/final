...
#wrap-contents {padding: 3rem 0; border-top: 1px dashed #dadada;}  
</style>
</head>
        ...
        <div class="container" >
          <div class="row">
            ...
            <div class="col-lg-10 col-md-10">
        	 <div id="h1tag">
        	 <h1 id="title" style="margin-bottom: 10px;"><img src="${pageContext.request.contextPath}/resources/images/weight.png" style="width: 40px; height: 40px; margin-bottom: 10px;">
        	 나의 <span class="color">BMI 지수</span> 확인하기</h1></div>
			...
			<form name="bmi" action="${pageContext.request.contextPath}/diet/bmiResult.do" method="get">
				<table id="bmitable">
					...
					<tr>
						<th>몸무게</th>
						<td><input type="text" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="3" 
						           name="wei" required="required"/> kg </td>
					</tr>
				</table>
