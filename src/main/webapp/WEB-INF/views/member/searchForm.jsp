...
<style>
    ...
    body, h1, input, p, select, option, label {font-family: sans-serif;}
	...
	#login_text { font-family: sans-serif;}
		...
		<div class="row">
			<div class="col-12" id="info_area">
				<form class="form-signin" action="${pageContext.request.contextPath}/member/search_action.do?${page_info}" onsubmit="return form_chk();" method="post">
					<h1 class="h1 font-weight-normal" id="login_text"><br />${page_name}</h1>
					...
					<div class="col-8 offset-2" id="id_area">
						<div class="row">
							<c:if test="${page_info eq 'pw_Find'}">
								<div class="col-4">					
									<label for="userInfo" id="info_label">아이디 : </label>
								</div>
					...
					<div class="col-8 offset-2" id="phone_area">
						<div class="row">
							<div class="col-4">
					...
					<div class="col-8 offset-2" id="email_area">
						<div class="row">
							<div class="col-4" id="email_label_div">
								<label for="userEmail" id="email_label">이메일 : </label>
							</div>
							<div class="col-8" style="margin: 0; padding: 0;">
								<div class="row">
