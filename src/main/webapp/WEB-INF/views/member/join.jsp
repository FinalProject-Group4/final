...
input, a, div, h3, h4, h2, h1, span, p, text, #id_chk, 
#pwd_chk, #pwdChk_chk, #userNick_chk, #userPhone_chk, #userEmail_chk, #EmailCode_chk {font-family: 'InfinitySans-RegularA1'}
label {
	font-size: 16px;
	line-height: 35px;
}
...
#emailchk_btn, #address_btn, #submitbtn {
    background-color: #f8c7b8!important;
...
#emailchk_btn:hover, #address_btn:hover, #submitbtn:hover {background: #ffb3b3!important; cursor: pointer!important;}

#resetbtn {background-color:#ffe6cc!important; color: black!important; border: none!important; font-family: 'InfinitySans-RegularA1';}

#resetbtn:hover {background-color:#ffce99!important; color: red!important;}
...
<body>
   ...
   <section class="section" style="padding-top: 40px;">
	<div class="container">
	  <div class="row">
		   <div class="col-2"></div>
			<div class="col-8" id="login_area"><br>
				<form action="memberJoin.do" method="post" onsubmit="return form_chk();">
					<div id="h1tag"><h1 class="h1 font-weight-normal" id="signup_text" style="text-align: center; color: black; font-size: 50px;">SIGN UP</h1></div>
			<div class="col-12">
			...
			<div class="row info" id="email_area">
				...
				<div class="col-3">
					...
					ight" id="emailchk_btn"
						disabled="disabled" style="padding: 10px;">인증메일 전송</button>
				</div>
			</div>
