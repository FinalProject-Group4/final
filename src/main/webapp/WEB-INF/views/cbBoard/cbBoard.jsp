...
th, td {color: black; border: 1px solid lightgrey; font-family: 'InfinitySans-RegularA1'; text-align: center;}
...
<body>
	...
	<section id="wrap-contents">
         <div class="container" >
            <div id="slide-right">
              <h2 class="content content-title"><i id="icon" class="fa fa-book" aria-hidden="true"></i>CALORIE DICTIONARY</h2>
            </div>
