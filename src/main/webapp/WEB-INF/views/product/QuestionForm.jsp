              ...
              <div class="row">
				...
				<br>
				 <div>
				    ...
				    <button class="btn btn-primary" id="btnReset" type="button" onclick="location.href='${pageContext.request.contextPath}/product/productView.do?no=${product.p_No}'">취소</button>
			     </div>
			</form>
		</div>
	    </div>
