    ...
    function onMessage(evt){
        ...
        if(strArray.length>1) {
            ...
            if(host==ck_host||(host==0&&ck_host.includes('0:0:'))) {
                ...
                printHTML+="<strong>["+m_Nick+"] : "+message+"</strong>";
                printHTML+="</div>";
                printHTML+="</div>";
...
body, textarea {font-family: 'InfinitySans-RegularA1'!important;}
#message {padding: 15px;}
</style>
</head>
<body>
<div class='form-group'>
    <label id='sessionuserid'><h3>${member.m_Nick}님, 어서오세요!</h3></label><br/>
    <!-- 대화내용이 출력되는 부분 -->
