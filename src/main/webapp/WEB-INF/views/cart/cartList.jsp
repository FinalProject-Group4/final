					...
					<tr id="${cl.c_No}">
						<td class="td" style=" padding: 14px;">
							<a href="${pageContext.request.contextPath}/product/productView.do?no=${cl.c_Pno}">
								<img src="${pageContext.request.contextPath}/resources/images/DT3.jpg" alt="" width="100" height="100" />					
							</a>
						</td>
						<td class="td" style="text-align: left; padding-left: 40px;">${cl.p_Name}</td>
						<td class="td"><fmt:formatNumber type="number" maxFractionDigits="3" value="${cl.p_Price}" /> 원</td>
