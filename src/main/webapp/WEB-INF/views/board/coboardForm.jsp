			  ...
			  <input type="hidden" name="co_Mno" value="${member.m_No}" readonly>
				<table class="co_table">
					<tr>
					  <th>카테고리</th>
						<td>
							<select name="co_Type" id="co_Type" style="height: 30px;">
					...
					<th>제목</th>
						<td>
							<input class="form-control" type="text" name="co_Title" id="co_Title" required placeholder="제목을 입력해주세요." >
						</td>
					</tr>
					<tr>
					<th>첨부파일1</th>
		            ...
		            <th>내용</th>
		             <td>
		                <textarea class="form-control" name="co_Content" id="co_Content" placeholder="내용을 입력해주세요." required></textarea>
		        	 </td>
		        	</tr>
		        </table>
				<br />
