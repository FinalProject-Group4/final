             ...
             <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			  ...
			  <input type="hidden" name="co_No" value="${co_board.co_No }" />
				...
				<div>
				   ...
				   <button class="btn btn-primary" id="btnReset" type="button" onclick="location.href='${pageContext.request.contextPath}/board/boardView.do?no=${co_board.co_No}'">취소</button>
