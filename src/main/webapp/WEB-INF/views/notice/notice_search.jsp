	      ...
	      <div class="container">
	        <div class="row">
			 <div class="col-lg-7 col-md-7">
                ...
                <i id="icon" class="fa fa-list-alt" aria-hidden="true"></i>NOTICE</h2>
             </div><!-- end col -->
		    ...
		    <br>
                  <h4 class="h3tag content"><span class="span-color" style="color:#38a1f2;">" ${keyword} " </span>(으)로 <span class="span-color">${count}</span>개 검색되었습니다.</h4><br>
                <!-- table -->               
                     <table id="tbl-board" class="table table table-hover">
					   ...
					   <tr id="${n.n_no}">
					      ...
					      <td readonly><!--  ${n.n_mno} ${member.m_Name} -->관리자</td>
					      <td>${n.n_count }</td>
					      <td>${n.n_date}</td>
					   </tr>
					   </c:forEach>
