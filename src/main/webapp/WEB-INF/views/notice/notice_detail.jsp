             ...
             <div class="container">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="padding: 0px;">
                   <div class="page-wrapper">
					...
					<tr>
						<td><i id="td_icon" class="fa fa-user-o" aria-hidden="true"></i><!--${member.m_Nick }-->관리자</td>
					</tr>
					<tr>
						<td><i id="td_icon" class="fa fa-calendar-check-o" aria-hidden="true"></i>${notice.n_date} &nbsp;
						    <i id="td_icon" class="fa fa-eye" aria-hidden="true"></i>${notice.n_count}
						</td>
					</tr>
					<tr>
						<td id="content_td">
