	      ...
	      <div class="container">
			...
			<div class="row">
			 <div class="col-lg-7 col-md-7" id="slide-right">
                ...
                <i id="icon" class="fa fa-youtube-play" aria-hidden="true"></i>HOME TRAINING</h2>
             </div><!-- end col -->
				  ...
				  <div class="col-md-12">
					<div class="gall-list01 clfix">
						...
						<li id="${ht.ht_No }">
							...
							<div class="tit2">${ht.ht_Part} <img src="${pageContext.request.contextPath}/resources/images/bar.PNG"><i id="td_icon" class="fa fa-eye" aria-hidden="true"></i> ${ht.ht_Count} </div>
						</li>
					 	</c:forEach>
					</div>
				  </div>
