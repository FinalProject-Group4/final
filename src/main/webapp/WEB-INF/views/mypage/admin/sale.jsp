                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right">
                                	<c:choose>
                                		<c:when test="${(todayOrders / yesterdayOrders) gt 1}">
                                			<i class="fa fa-fw fa-caret-up text-success"></i>
                                			<span class="text-success">
                                				<fmt:formatNumber value="${(todayOrders / yesterdayOrders)}" pattern="0.00"/>%
                                			</span>
                                		</c:when>
                                		<c:when test="${(todayOrders / yesterdaySale) lt 1}">
                                			<i class="fa fa-fw fa-caret-down text-danger"></i>
                                			<span class="text-danger">
                                				<fmt:formatNumber value="${1-(todayOrders / yesterdayOrders)}" pattern="0.00"/>%
                                			</span>
                                		</c:when>
                                		<c:otherwise>
                                			 <i class="fa fa-fw fa-minus" style="color: black;"></i><span>0%</span>
                                		</c:otherwise>
                                	</c:choose>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right text-danger">
                                   <c:choose>
                                		<c:when test="${(todaySale / yesterdaySale) gt 1}">
                                			<i class="fa fa-fw fa-caret-up text-success"></i>
                                			<span class="text-success">
                                				<fmt:formatNumber value="${(todaySale / yesterdaySale)}" pattern="0.00"/>%
                                			</span>
                                		</c:when>
                                		<c:when test="${(todaySale / yesterdaySale) lt 1}">
                                			<i class="fa fa-fw fa-caret-down text-danger"></i>
                                			<span class="text-danger">
                                				<fmt:formatNumber value="${1-(todaySale / yesterdaySale)}" pattern="0.00"/>%
                                			</span>
                                		</c:when>
                                		<c:otherwise>
                                			 <i class="fa fa-fw fa-minus" style="color: black;"></i><span>0%</span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="metric-label d-inline-block float-right">
                                    <i class="fa fa-fw fa-minus" style="color: black;"></i><span></span>
                                </div>
                            </div>
                            <div id="sparkline-3">
                            </div>
