        ...
        var real = confirm("정말 삭제하시겠습니까?")
	        ...
	        $.ajax({
	            ...
	            success: function(jdata){
	                if(jdata == 1) {
	                    alert("삭제 성공");
	                    location.href = "${pageContext.request.contextPath}/mypage/managementCO.do"
	                }
	                else {
	                    alert("삭제 실패");
	               	}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	...
                        	<div class="btn-group">
	                        	<button class="btn btn-primary" id="btn-delete" type="button" onclick="deletecbBoard();">선택 삭제</button>
                        	</div>
                        	<p style="float: right; margin-right: 25px; margin-bottom:5px; font-family: 'InfinitySans-RegularA1';">총 ${totalContents}건이 게시글이 있습니다.</p>
								...
								<table class="table">
									...
									<tr id="${coBoard.co_No}">
										...
										<td>${coBoard.nick}</td>
										<c:choose>
										<c:when test="${coBoard.co_Status eq 'Y'}">
											<td>게시중</td>
										</c:when>
										<c:when test="${coBoard.co_Status eq 'N'}">
											<td>삭제됨</td>
										</c:when>
										</c:choose>
