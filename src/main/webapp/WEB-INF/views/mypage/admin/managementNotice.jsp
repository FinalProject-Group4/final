                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	<h2 class="content content-title"><i id="icon" class="fa fa-list-alt" aria-hidden="true"></i> 공지사항 관리

                        		<button class="btn btn-primary" id="btn-delete" type="button" onclick="deleteNotice();">선택 삭제</button>
                        	</h2>
                        	<p style="float: right; margin-right: 25px; margin-bottom:5px; font-family: 'InfinitySans-RegularA1';">총 ${totalContents}건의 공지사항이 등록되어있습니다.</p>
