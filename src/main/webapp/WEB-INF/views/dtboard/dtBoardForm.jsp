								...
								<form action="${pageContext.request.contextPath}/dtboard/dtBoardFormEnd.do"
								    ...
								    <table  class="sub_news" border="1px solid gray" align="center" >
								      	<tr>
											<th>카테고리</th>
											<td>
												<select name="dt_Type" id="dt_Type" style="height: 30px;">
								      	...
								      	<tr>
								      		<th>첨부 파일</th>
								      		<td>&nbsp;<input type="file" name="upfiles" class="inputfile" id="upfiles" />
								    ...
								    <br/>
								    <div>
								    	<button class="btn btn-primary" id="btnBack" type="button"><a href="${pageContext.request.contextPath}/dtboard/dtBoardList.do" style="color: #333; align:left;">목록으로</a></button>
