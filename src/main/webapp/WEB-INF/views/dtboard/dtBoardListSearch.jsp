        ...
        <section class="page-title wb">
            <div class="container">
              <div class="row">
                ...
                <i id="icon" class="fa fa-thumbs-o-up" aria-hidden="true"></i>DIET TIPS</h2>
              </div><!-- end col -->
                                    ...
                                    <div class="col-md-5">
                                        <div class="post-media">
                                            <a href="${pageContext.request.contextPath}/dtboard/dtBoardView.do?no=${b.dt_No}" title="">
                                                ...
                                                <img src="${pageContext.request.contextPath}/resources/dtboardUpload/${b.files[0].f_Cname}" width="445" height="296" >
                                              </c:if>
											  <c:if test="${ empty b.files }">
												  <img src="${pageContext.request.contextPath}/resources/images/no_image.png" width="445" height="296">
											  </c:if>
